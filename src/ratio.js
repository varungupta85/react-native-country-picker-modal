...
const getHeight = () => (React.Platform.OS === 'android' ? height - ANDROID_MINUS_HEIGHT : (isIphoneX ? height - iPHONE_X_MINUS_HEIGHT : height));
...
export const getTop = () => (isPhoneX ? 44: 0);
export const getBottom = () => (isPhoneX ? 34:0)
